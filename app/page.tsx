...
const skills = ["Python", "C++", "C#", "Dart", "HTML", "Firebase"];
    ...
    <section className="flex min-h-screen flex-col items-center justify-center px-6 text-center">
      <div className="max-w-3xl">
        ...
        <p className="mx-auto mb-10 max-w-xl text-lg leading-relaxed text-muted md:text-xl">
          Teknolojiye meraklı, yeni şeyler öğrenmeyi seven biriyim. Kodlama ile
          ilgili projeler yapmayı seviyorum.
        </p>
        ...
        <div className="grid gap-8 md:grid-cols-2">
          <div className="rounded-2xl border border-card-border bg-card p-8">
            ...
            <p className="text-sm leading-relaxed text-muted">
              Sabancı Üniversitesi Bilgisayar Mühendisliği bölümünde lisans
              eğitimime devam ediyorum. Algoritmalar, veri yapıları ve yazılım
              mühendisliği alanlarında kendimi geliştiriyorum.
            </p>
          </div>
          <div className="rounded-2xl border border-card-border bg-card p-8">
            <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-xl bg-accent/10 text-accent">
            ...
            <p className="text-sm leading-relaxed text-muted">
              Python, C++, C#, Dart ve HTML dillerinde deneyim sahibiyim.
              Firebase ile backend geliştirme ve Flutter ile mobil uygulama
              projeleri üretiyorum.
            </p>
          </div>
        </div>
      </div>
    ...
    <section id="iletisim" className="px-6 py-24">
      <div className="mx-auto max-w-2xl text-center">
        ...
        <p className="mb-10 text-muted">
          Bir projeniz mi var ya da sadece merhaba mı demek istiyorsunuz? Bana
    ...
    <footer className="border-t border-card-border px-6 py-8">
      <div className="mx-auto flex max-w-6xl items-center justify-center">
        <p className="text-sm text-muted">
          &copy; 2026 Mete Yılmazbaş. Tüm hakları saklıdır.
        </p>
      </div>
    </footer>
  );
